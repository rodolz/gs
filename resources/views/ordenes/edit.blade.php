@extends('layout.master')
    ...
    @section('panel-title')
       <h2 class="title pull-left">Modificando Nota de entrega #{{ $orden->num_orden }}</h2>
    @endsection
            ...
            <div class="row">
	           ...
	           {!! Form::model($orden, ['id' => 'orden_form','name' => $orden->id,'class' => 'form-inline']) !!}
                    ...
                    <div class="well transparent">
                        ...
                        <div class="row top15">
                            <div class="form-group col-lg-4 col-md-4 col-sm-9 col-xs-12">
                                <div class="list-group" id="lista_repartidores">
                                    <div class="list-group-item">
                                        <h4 class="list-group-item-heading bold text-center">Repartidores Seleccionados</h4>
                                    </div>
                                    @foreach($repartidores_seleccionados as $repartidor)
                                    <li idRepartidor="{{ $repartidor->id }}" class='list-group-item active'><span class='badge'><a idRepartidor="{{ $repartidor->id }}"><i class='fa fa-times'></i></a></span>{{ $repartidor->nombre }}</li>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row top15">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                <button type="submit" class="btn btn-primary right15">Modificar</button>

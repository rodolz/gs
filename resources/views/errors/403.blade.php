            ...
            <section class="box nobox">
                <div class="content-body">    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <h1 class="page_error_code text-primary">403</h1>
                            <h1 class="page_error_info"><strong>No tiene permisos para esta accion</strong></h1>
                            ...
                            <!--         <div class="input-group transparent">
                                    ...
                                    <div class="text-center page_error_btn">
                                        <a class="btn btn-primary btn-lg btn-corner" href='{{ URL::route("index") }}'><i class='fa fa-arrow-left' style='font-size:20px;'></i> Regresar</a>
                                    </div>
                                </form>
                            </div>

@extends('layout.master')
    ...
    @section('panel-title')
       <h2 class="title pull-left">Nuevo Control</h2>
    @endsection
        ...
        <section class="box primary">
            ...
            <div class="content-body">    
                <div class="row">
                   ...
                   {!! Form::model($orden, ['id' => 'factura_form','name' => $orden->id,'class' => 'form-inline']) !!}
                    ...
                    <div class="well transparent">
                        <div class="row">
                            <div class="form-group col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                ...
                                <div class="controls">
                                        {!! Form::select('id', $ordenes_fmt, null, ['id' => 'orden', 'placeholder' => 'Seleccione...', 'class' => 'form-control top15']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
